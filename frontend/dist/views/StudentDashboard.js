...
const StudentDashboard = () => {
    ...
    return (_jsx(Container, { className: 'student-main-container', children: _jsxs(Row, { className: "student-main-row", children: [_jsxs(Col, { xs: "12", lg: "8", children: [signedInStudent ?
                            ...
                            : _jsx("div", { className: "second-heading", children: t('noProjects') }), _jsx("hr", {})] }), _jsx(Col, { xs: "12", lg: "4", style: { marginTop: "25%" }, children: _jsx(Button, { href: "/form", variant: "primary", size: "sm", style: { width: "200px" }, children: t('createProj') }) })] }) }));
};
