...
const StudentDashboard = () => {
    ...
    const studentId = (signedInStudent === null || signedInStudent === void 0 ? void 0 : signedInStudent.student_id) || 0;
    ...
    const studentProjectsWithData = studentProjectsList === null || studentProjectsList === void 0 ? void 0 : studentProjectsList.map(project => {
        ...
        return Object.assign(Object.assign({}, project), { project_name: (projectData === null || projectData === void 0 ? void 0 : projectData.project_name) || "No project name", project_desc: (projectData === null || projectData === void 0 ? void 0 : projectData.project_desc) || "No project description", project_status: (projectData === null || projectData === void 0 ? void 0 : projectData.project_status) || "No project status", teacher_name: foundTeacher ? `${foundTeacher.teacher_name}` : "no teacher", teacher_id: (projectData === null || projectData === void 0 ? void 0 : projectData.teacher_id) || null, company_id: (projectData === null || projectData === void 0 ? void 0 : projectData.company_id) || null, company_name: ((_a = companies === null || companies === void 0 ? void 0 : companies.find(company => company.company_id === (projectData === null || projectData === void 0 ? void 0 : projectData.company_id))) === null || _a === void 0 ? void 0 : _a.company_name) || "No company name", start_date: (projectData === null || projectData === void 0 ? void 0 : projectData.start_date) || "No start date", end_date: (projectData === null || projectData === void 0 ? void 0 : projectData.end_date) || "No end date", project_url: (projectData === null || projectData === void 0 ? void 0 : projectData.project_url) || "No project url", studentsInvolved: (studentProjects === null || studentProjects === void 0 ? void 0 : studentProjects.filter(proj => proj.project_id === project.project_id).map(student => { var _a; return (_a = students.find(stud => stud.student_id === student.student_id)) === null || _a === void 0 ? void 0 : _a.student_name; })) || "No students involved" });
    });
    return (_jsx(Container, { className: 'student-main-container', children: _jsxs(Col, { xs: "12", lg: "9", children: [_jsxs(Row, { children: [signedInStudent ?
                            _jsxs("div", { children: [_jsx("h4", { children: signedInStudent.student_name }), _jsx("div", { style: { fontSize: "small" }, children: signedInStudent.email }), _jsx("div", { style: { fontSize: "small" }, children: signedInStudent.class_code ? signedInStudent.class_code.toUpperCase() : "no code" })] })
