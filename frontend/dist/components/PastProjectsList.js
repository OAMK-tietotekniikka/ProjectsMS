...
const PastProjectsList = () => {
    ...
    const projectsForSignedInTeacher = (projects === null || projects === void 0 ? void 0 : projects.filter(project => project.teacher_id === 1 && (project.project_status === 'completed'))) || [];
