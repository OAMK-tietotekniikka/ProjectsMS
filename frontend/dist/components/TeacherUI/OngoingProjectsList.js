...
const OngoingProjectsList = ({ teacherId }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { children: _jsx(SelectionDropdown, { data: projectsWithStudents, options: selectionOptions, toggle: 'selectStudents', setSelectedData: setSelectedData }) }), _jsx("div", { className: "projects-table", children: _jsxs(Table, { hover: true, size: 'sm', className: "table-custom", children: [_jsx("thead", { children: _jsxs("tr", { style: { fontSize: "13px" }, children: [_jsx("th", {}), _jsx("th", { children: t('studyGroup') }), _jsx("th", { children: t('started') }), _jsx("th", { children: t('ended') }), _jsx("th", { children: t('companyName') }), _jsx("th", { children: t('projectNo') }), _jsx("th", { children: t('setEnded') })] }) }), _jsx("tbody", { children: dataToDisplay.map((proj) => (_jsxs("tr", { style: { fontSize: "13px" }, onClick: () => handleRowClick(proj), children: [_jsxs("td", { className: "align-middle", style: { display: "flex", flexDirection: "column" }, children: [_jsx("div", { style: { fontWeight: "bold" }, children: proj.name }), _jsx("div", { children: proj.student_email })] }), _jsx("td", { children: (proj.class_code).toUpperCase() }), _jsx("td", { children: String(proj.start_date).split('T')[0] }), _jsx("td", { children: String(proj.end_date).split('-')[0] === "1970" ? "not set" : String(proj.end_date).split('T')[0] }), _jsx("td", { children: proj.company_name }), _jsx("td", { children: proj.project_number }), _jsx("td", { children: _jsx("button", { style: { height: "20px", width: "20px", marginLeft: "20% ", padding: "0", border: "none" }, onClick: (e) => { e.stopPropagation(); handleChecked(proj); }, children: _jsx("img", { src: selectedProjectId === proj.project_id ? checkboxImage : squareImage, alt: "tick" }) }) })] }, proj.project_id))) })] }) }), _jsxs(Modal, { show: show, onHide: () => { handleClose(); setSelectedProjectId(null); }, animation: false, children: [_jsx(Modal.Header, { closeButton: true, children: _jsx(Modal.Title, { children: "Are you sure you want to set the following project completed?" }) }), _jsx(Modal.Body, { children: _jsxs("div", { children: [_jsx("h6", { children: "Modified data:" }), _jsxs("div", { children: ["Student name: ", studentName] }), _jsxs("div", { children: ["Project name: ", modifiedProjectData === null || modifiedProjectData === void 0 ? void 0 : modifiedProjectData.project_name] }), _jsxs("div", { children: ["Ending date: ", modifiedProjectData === null || modifiedProjectData === void 0 ? void 0 : modifiedProjectData.end_date.toISOString().split('T')[0]] }), _jsxs("div", { children: ["Project status: ", modifiedProjectData === null || modifiedProjectData === void 0 ? void 0 : modifiedProjectData.project_status] })] }) }), _jsxs(Modal.Footer, { children: [_jsx(Button, { variant: "secondary", onClick: () => { handleClose(); setSelectedProjectId(null); }, children: "No, go back" }), _jsx(Button, { style: { backgroundColor: "#F7921E" }, onClick: () => handleConfirm(), children: "Yes, save changes" })] })] })] }));
};
