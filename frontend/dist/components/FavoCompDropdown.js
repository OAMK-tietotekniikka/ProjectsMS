...
const FavoCompDropdown = ({ data }) => {
    ...
    return (_jsx(Container, { style: { paddingLeft: "0px", marginTop: "2%" }, children: _jsxs(Col, { children: [_jsx("div", { children: t('selectComp') }), _jsxs("div", { className: 'dropdown-row', children: [_jsxs(Dropdown, { children: [_jsx(Dropdown.Toggle, { id: "dropdown-basic", className: 'dropdown-toggle', children: t('select') }), _jsx(Dropdown.Menu, { children: (data === null || data === void 0 ? void 0 : data.map((item, index) => (_jsx(Dropdown.Item, { onClick: () => addToList(item), className: `dropdown-item ${favoCompanies.some(company => company.company_id === item.company_id) ? 'active' : ''}`, href: "#/action-${index}", children: item.company_name }, index)))) || _jsx(Dropdown.Item, { children: t('noComp') }) })] }), _jsxs("div", { style: { marginLeft: "20%" }, children: [_jsx("div", { className: "second-heading", children: t('selectedCompList') }), _jsx(ListGroup, { children: (favoCompanies.length > 0) ? favoCompanies.map((item, index) => (_jsx(ListGroup.Item, { className: 'list-item', children: item.company_name }, index))) : _jsx(ListGroup.Item, { children: t('noFavoComp') }) }), _jsx(Button, { style: { marginTop: "6px" }, className: 'addCompany-button', onClick: () => saveSelection(), children: t('saveSelection') })] })] }), _jsx("div", { children: t('enterNewComp') }), _jsxs("div", { className: 'dropdown-row', children: [_jsx(Form, { children: _jsx(Form.Control, { type: "text", placeholder: "Enter company name", style: { width: "300px" }, onChange: (e) => handleChange(e.target.value), value: newCompany }) }), _jsx(Button, { style: { marginLeft: "20%" }, type: 'button', className: 'addCompany-button', onClick: handleSubmit, children: t('saveInput') })] })] }) }));
};
