...
const ProjectForm = ({ onSubmit }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        project_desc: (proj === null || proj === void 0 ? void 0 : proj.project_description) || '',
