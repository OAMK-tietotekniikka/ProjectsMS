...
const OngoingProjectsList = ({ teacherId }) => {
    ...
    const projectsWithStudents = projectsWithCompanyNames.map((project) => {
        ...
        return Object.assign(Object.assign({}, project), { project_number: (studentProject === null || studentProject === void 0 ? void 0 : studentProject.project_number) || 'Unknown Project Number', name: studentName, student_email: (student === null || student === void 0 ? void 0 : student.email) || 'Unknown Email', class_code: (student === null || student === void 0 ? void 0 : student.class_code) || 'Unknown Class Code', studentsInvolved: (studentProjects === null || studentProjects === void 0 ? void 0 : studentProjects.filter(proj => proj.project_id === project.project_id).map(student => { var _a, _b; return ((_a = students.find(stud => stud.student_id === student.student_id)) === null || _a === void 0 ? void 0 : _a.first_name) + ' ' + ((_b = students.find(stud => stud.student_id === student.student_id)) === null || _b === void 0 ? void 0 : _b.last_name); })) || "No students involved", teacher_name: ((_c = teachers === null || teachers === void 0 ? void 0 : teachers.find(teacher => teacher.teacher_id === project.teacher_id)) === null || _c === void 0 ? void 0 : _c.first_name) + ' ' + ((_d = teachers.find(teacher => teacher.teacher_id === project.teacher_id)) === null || _d === void 0 ? void 0 : _d.last_name) || "No teacher name" });
    });
