...
const StudentProjectDetails = () => {
    ...
    return (_jsx(Container, { className: "student-main-container", children: _jsxs(Row, { className: "student-main-row", children: [_jsxs(Col, { xs: "12", lg: "7", children: [_jsxs("h4", { children: [t('projectNo'), " ", proj.project_number] }), _jsx("h6", { children: proj.project_name }), _jsxs("div", { style: { margin: "20px 0" }, children: [_jsxs("div", { style: { fontWeight: "bold" }, children: [t('projDesc'), " :"] }), _jsx("div", { children: proj.project_desc })] }), _jsxs(Row, { children: [_jsx(Col, { className: "grey-text", children: t('status') }), _jsx(Col, { children: t(proj.project_status) })] }), _jsxs(Row, { children: [_jsx(Col, { className: "grey-text", children: t('company') }), _jsx(Col, { children: proj.company_name })] }), _jsxs(Row, { children: [_jsx(Col, { className: "grey-text", children: t('startDate') }), _jsx(Col, { children: String(proj.start_date).split('T')[0] })] }), _jsxs(Row, { children: [_jsx(Col, { className: "grey-text", children: t('dueDate') }), _jsx(Col, { children: String(proj.end_date).split('-')[0] === "1970" ? "not set" : String(proj.end_date).split('T')[0] })] }), _jsxs(Row, { children: [_jsx(Col, { className: "grey-text", children: t('url') }), _jsx(Col, { children: proj.project_url ? proj.project_url : "no url added" })] }), _jsxs(Row, { children: [_jsx(Col, { className: "grey-text", children: t('supervisor') }), _jsx(Col, { children: proj.teacher_name })] }), _jsxs(Row, { children: [_jsx(Col, { className: "grey-text", children: t('studInvolved') }), _jsx(Col, { style: { display: "flex", flexDirection: "column" }, children: proj.studentsInvolved.map((student, index) => (_jsx(Col, { children: student }, index))) })] }), _jsx(Button, { className: "student-view-button margin-right", onClick: () => navigate('/form', { state: { proj } }), children: t('modifyData') }), user === "teacher" ?
