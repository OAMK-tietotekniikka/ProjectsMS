...
exports.updateTeacher = exports.getTeachersByCompany = exports.createTeacher = exports.getTeacher = exports.getTeachers = void 0;
...
const getTeacher = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error(`[${new Date().toLocaleDateString()}] ${error}`);
        return res.status(code_enum_1.Code.INTERNAL_SERVER_ERROR)
            .send(new response_1.HttpResponse(code_enum_1.Code.INTERNAL_SERVER_ERROR, status_enum_1.Status.INTERNAL_SERVER_ERROR, 'An error occurred while fetching teacher'));
    }
    finally {
        if (connection)
            connection.release();
